...
export const SIGNUP_ERROR_MESSAGES = {
  en: {
    ...
    googleConfig: 'Google sign-in is not configured yet. Add NEXT_PUBLIC_GOOGLE_CLIENT_ID in .env.local.',
  ...
  hi: {
    ...
    googleConfig: 'Google sign-in configure नहीं है। .env.local में NEXT_PUBLIC_GOOGLE_CLIENT_ID जोड़ें।',
