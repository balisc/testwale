...
/** One Supabase round-trip set per 24h (or until `revalidateTag('catalog')`). */
export const getCatalogSnapshot = unstable_cache(fetchCatalogSnapshot, ['catalog-snapshot-v1'], {
