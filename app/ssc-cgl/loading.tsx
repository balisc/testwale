export default function SscCglLoading() {
  return (
    <main className="min-h-screen w-full min-w-0 max-w-full bg-[#F8FAFC] px-4 py-6 sm:px-6 sm:py-8 lg:px-8" role="status" aria-live="polite">
      <div className="mx-auto w-full min-w-0 max-w-6xl animate-pulse">
        ...
        <span className="sr-only">Loading SSC CGL page</span>
      </div>
    </main>
  );
}
