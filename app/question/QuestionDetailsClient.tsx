...
function sanitizeQuestion(question: QuestionItem & { question_text?: LocalizedText }): SanitizedQuestion {
  ...
  return {
    ...
    source_metadata: question.source_metadata ?? null,
  };
}
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          {/* Correct answers stay server-gated — never SSR-render answer keys on public pages. */}
          {sanitizedQuestion.source || sanitizedQuestion.source_metadata ? (
            <VerifiedSources
              source={sanitizedQuestion.source}
              sourceMetadata={sanitizedQuestion.source_metadata}
