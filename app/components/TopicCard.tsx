...
export default function TopicCard({ topic, onSelect, language }: TopicCardProps) {
  ...
  return (
    <button
      ...
      className="group rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900/50 to-slate-950 p-6 shadow-lg transition duration-200 ease-out transform hover:-translate-y-0.5 hover:border-emerald-400/50 hover:shadow-[0_0_30px_rgba(16,185,129,0.15)] active:scale-95"
    >
