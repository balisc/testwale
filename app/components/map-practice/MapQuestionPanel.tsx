    ...
    <section className="rounded-lg border border-slate-200 bg-white p-4">
        ...
        <>
          ...
          {!submitted && (
            <div className="mt-3">
              ...
              >
                {hintLevel === 0 ? 'Hint 1: Show Region' : hintLevel === 1 ? 'Hint 2: Zoom Near Answer' : 'Hints Exhausted'}
              </button>
          ...
          {submitted && feedback && (
            ...
            >
              ...
              {question.explanation && <p className="mt-2 text-sm text-slate-700">Explanation: {question.explanation}</p>}
            </div>
          )}
        </>
      )}
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <button
          type="button"
          onClick={onSubmit}
          disabled={!question || !selectedPoint || submitted}
