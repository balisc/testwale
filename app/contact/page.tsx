...
const title = 'Contact Questionwale - Coming Soon';
const description = 'The Questionwale contact page is being updated. Browse subjects and continue practicing competitive exam MCQs.';
...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, url: '/contact', type: 'website', siteName: 'Questionwale' },
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-24 text-slate-900">
      <section className="mx-auto max-w-3xl rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-sm sm:p-12">
        <p className="text-sm font-semibold uppercase tracking-[0.35em] text-slate-500">Contact Us</p>
        <h1 className="mt-4 text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl">Coming soon</h1>
        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-slate-600">
          We are preparing a better contact experience. Until then, you can continue exploring subjects and practicing MCQs.
        </p>
