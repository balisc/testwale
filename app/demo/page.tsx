...
export const metadata: Metadata = {
  title: 'Sources of the Indian Constitution — Revision | QuestionWale',
  description:
    'Focused revision for Sources of the Indian Constitution: rescue card, source map, mindmap, confusion table and verified NCERT references — then practise the subtopic questions.',
