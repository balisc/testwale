...
export default function ExamSubjectsGrid({
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-10">
      {showHeader ? <header className="text-center"><h1 className="text-3xl font-extrabold text-slate-900 sm:text-4xl">{copy.title}</h1><p className="mt-3 text-slate-600">{copy.subtitle}</p></header> : null}
      <div className={`${showHeader ? 'mt-10' : ''} grid gap-5 sm:grid-cols-2 lg:grid-cols-3`}>
