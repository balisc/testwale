...
export async function GET(request: Request) {
  try {
    ...
    // Unified catalog `questions` has subject_id/topic_id — not subject/topic text columns.
    // Without catalog IDs/slugs, do not probe invalid JSON columns (raises Postgres 42703).
