    ...
    <section className="border-y border-[#E4E7EC] bg-[#FAFAFC] py-16 sm:py-20 max-[479px]:py-10">
      <div className="home-container grid w-full gap-10 md:grid-cols-2 md:items-center md:gap-14 max-[479px]:gap-8">
        ...
        <div className="min-w-0 rounded-2xl border border-[#E4E7EC] bg-white p-5 shadow-[0_16px_40px_-28px_rgba(24,24,27,0.35)] sm:p-6 max-[479px]:p-3">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#667085] max-[479px]:text-[10px] max-[479px]:tracking-wide">
            ...
            {WORKFLOW.map((step, index) => (
              <li key={step} className="relative flex gap-4 pb-5 last:pb-0 max-[479px]:gap-3">
                ...
                <div className="min-w-0 pt-1.5">
                  ...
                  {index < WORKFLOW.length - 1 ? (
                    <p className="mt-0.5 text-xs text-[#667085]">Then reviewed in the next stage</p>
                  ) : (
                    <p className="mt-0.5 text-xs text-[#667085]">Reports help continuous improvement</p>
                  )}
                </div>
              </li>
            ))}
